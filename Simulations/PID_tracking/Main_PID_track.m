...
% t_plan=linspace(0,t_sim,101*t_sim)';
...
% trajectory vs planned trajectory
...
plot(1000*x_ref(1),1000*y_ref(1),'ro')
rectangle('Position',[-1000*lx -1000*ly 1000*2*lx 1000*2*ly],'LineWidth',1.5)
grid on
xlabel('x [mm]','Interpreter','latex')
ylabel('y [mm]','Interpreter','latex')
title('Trajectory of the ball')
legend('actual trajectory','','reference trajectory','','Interpreter','LaTex','Location','best')
